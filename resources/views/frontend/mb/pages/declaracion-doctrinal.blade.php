<x-frontend.mb.layouts.app>
    <x-slot name="header">
        {{ __('Declaración Kerigma-Didaché') }}
    </x-slot>

    <div class="container mx-auto max-w-7xl px-6 my-12">
        <div class="flex w-full flex-col lg:flex-row mb-12">
            <!-- 1 -->
            <div class="flex-1">
                ...
                <ul class="text-red-500 list-disc list-inside">
                    <li class="bg-yellow-50/50 text-lg p-6 rounded-lg shadow mb-4">
        ...
        <div class="flex w-full flex-col lg:flex-row">
            ...
            <div class="flex-1">
                ...
                <hr class="my-4">
                <ul class="text-red-500 list-decimal list-inside">
                    <li class="bg-yellow-50/50 text-lg p-6 rounded-lg shadow mb-4">
